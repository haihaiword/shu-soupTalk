...
const pages = [
  ...
  {
    path: "pages/login/auto_login/auto_login",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false,
      navigationStyle: "custom"
...
const subPackages = [
  {
    ...
    pages: [
      ...
      {
        path: "soup-collection/soup-collection",
        style: {
...
const uniIdRouter = {
  loginPage: "pages/login/auto_login/auto_login",
  needLogin: [
    "pages/index/index",
    "pages/self/.*",
    "pages/detail/.*",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.113.1",\n        "192.168.116.1",\n        "192.168.8.166"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/86175/Downloads/HBuilderX.3.7.3.20230223/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"soup-talk-dev","spaceId":"mp-0e1b4477-5f41-45a2-9fbe-40973310bd59","clientSecret":"FBoABKvn0H8BFjwOFeT0Tg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__23B3761";
} catch (e2) {
